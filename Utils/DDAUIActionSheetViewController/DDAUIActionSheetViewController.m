...
- (IBAction)actionDelete:(UIButton *)sender {
    [self.delegate setValue:@"actionDelete" forKey:@"actionForRow"];
    [self slideOut];
}

- (IBAction)actionUnset:(UIButton *)sender {
    [self.delegate setValue:@"actionUnset" forKey:@"actionForRow"];
    [self slideOut];
}

- (IBAction)actionProlong:(UIButton *)sender {
    [self.delegate setValue:@"actionProlong" forKey:@"actionForRow"];
    [self slideOut];
}
