...
- (void)loadSettings
{
    ...
    self.rateLabel.text = @""; // тариф
    
    self.dueDateLabel; // тариф оплачен
    
    self.needToMakeLabel; // необходимо внести
    
    self.countAdv; // объявлений
    
    self.phoneNumberLabel; // Номер телефона
    
    self.createDateUserAccount; // Дата регистрации
    
    self.lastVisitLabel; // Последний визит
    
    self.emailLabel; // E-mail
}
